...
@summary_routes_bp.route("/section_summary/<spec_id>/<section_number>", methods=["POST"])
...
#     try:
#         all_sections = await db.get_all_sections(spec_id)
#         # response = all_sections.get("response")
#         for division in all_sections:
#             for section in all_sections[division]:
#                 if section["summary_status"] == "pending":
#                     await db.update_section_summary_status(spec_id, section["section_number"], "complete")
